...
const TopContent = () => {
  return (
    <div className="flex justify-between bg-gray-900 p-3 rounded-lg">
      ...
      <Link to="/paint/new" className="bg-black px-3 py-1 rounded-lg">
        Start Paint
      </Link>
    </div>
  );
...
const PaintItem = () => {
  return (
    <div className="flex  bg-gray-800 p-2 justify-between">
      ...
      <Link className="bg-black text-white px-2 py-1 rounded-lg" to="/paint">
        open
      </Link>
    </div>
  );
...
export default function Home() {
  // return <Paint width={500} height={500} />;
  return (
    <div>
      <TopContent />
      <PaintsList />
